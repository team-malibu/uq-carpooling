...
function ConfirmJohn(props) {
  ...
  return (
    ...
    <BasicPage name={"Confirm Driver"} body={createBody()} currentlySelected={0} previousPage='/Select' hide={false} direction={props.direction} default={props.default} key={props.key} custom={props.custom} update_direction={props.update_direction}/>
